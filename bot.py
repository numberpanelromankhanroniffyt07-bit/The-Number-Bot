...
PEM = {
    ...
    "upload": '<tg-emoji emoji-id="5445355530111437729">📤</tg-emoji>',
    "world": '<tg-emoji emoji-id="5431786620321817005">🌐</tg-emoji>',
    "lock": '<tg-emoji emoji-id="6050646916109179497">🔐</tg-emoji>',
...
GLOBAL_BODY_EMOJIS = {
    "➖": "5390831560238839648", "🚫": "6271807757276420702", "😒": "5310175463149151662",
    ...
    "🔤": "5433824784167214743", "📣": "5445355530111437729", "📤": "5240015420022346848",
    ...
    "👨‍⚖️": "5343579627128374980", "🔍": "5188217332748527444",
    "🔑": "5328037948665388988"
}

DEFAULT_CUSTOM_MESSAGES = {
    "start": {"text": "╭━━━━━━━━━━━━━━╮\n       📊 Number Bot\n╰━━━━━━━━━━━━━━╯\n🚀 Welcome to The Number Bot Service\n━━━━━━━━━━━━━━━━━━━\n✅ Choose an option below\nto continue using the bot.\n━━━━━━━━━━━━━━━━━━━\n💎 Premium OTP Service", "buttons": []},
    "get_number": {"text": f"{PEM['pin']} 𝐒𝐄𝐋𝐄𝐂𝐓 𝐘𝐎𝐔𝐑 𝐎𝐓𝐏 𝐒𝐄𝐑𝐕𝐈𝐂𝐄", "buttons": []},
    "select_country": {"text": f"𝐒𝐄𝐋𝐄𝐂𝐓 𝐘𝐎𝐔𝐑 𝐂𝐎𝐔𝐍𝐓𝐑𝐘 {{service}}:", "buttons": []}, 
...
bot_settings = {
    ...
    "main_channel": "https://t.me/Nr_Crypto_Market07",
    "withdraw_on": True,
    "min_withdraw": 50.0,
    "otp_reward": 0.0,
    "service_otp_rates": {},
...
def service_rates_keyboard():
    ...
    kb.append([{"text": "Add New Service", "icon_custom_emoji_id": "5445110205874459670", "callback_data": "dxa_add_srv", "style": "success"}])
    kb.append([{"text": "Back", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "dxa_control", "style": "danger"}])
...
def send_force_join_msg(chat_id):
    ...
    for ch in bot_settings["fj_channels"]:
        ...
        kb.append([{"text": f"Join Channel", "icon_custom_emoji_id": "5420163708674384414", "url": url, "style": "primary"}])
                    ...
                    for item in parsed_data:
                        ...
                        if unique_id not in processed_otps:
                            ...
                            for owner_id in owners:
                                ...
                                inbox_kb = [[{"text": f"{otp}", "icon_custom_emoji_id": "5444967350967228254", "copy_text": {"text": otp}, "style": "success"}]]
                                ...
                                if reward > 0 and reward_on:
                                    ...
                                    inbox_kb.append([{"text": f"Balance {reward} Tk", "icon_custom_emoji_id": "6271662346863646181", "callback_data": "ignore", "style": "primary"}])
...
def main_menu(user_id):
    kb = [
        [
            {"text": "𝐆𝐞𝐭 𝐍𝐮𝐦𝐛𝐞𝐫", "icon_custom_emoji_id": "5778379627726640492", "style": "primary"}, 
            {"text": "𝐒𝐞𝐚𝐫𝐜𝐡 𝐍𝐮𝐦𝐛𝐞𝐫", "icon_custom_emoji_id": "5188217332748527444", "style": "primary"}
        ],
        [
            {"text": "𝐓𝐫𝐚𝐟𝐟𝐢𝐜", "icon_custom_emoji_id": "5469749368099721284", "style": "success"}, 
            {"text": "𝟐𝐅𝐀 𝐎𝐧𝐥𝐢𝐧𝐞", "icon_custom_emoji_id": "5206432422194849059", "style": "primary"}
        ],
        [
        ...
        [
            {"text": "𝐒𝐮𝐩𝐩𝐨𝐫𝐭", "icon_custom_emoji_id": "5271801931814165886", "style": "primary"}
        ]
    ]
    if is_admin(user_id): 
...
def admin_panel_keyboard():
    return {"inline_keyboard": [
        [{"text": "𝐋𝐞𝐚𝐝𝐞𝐫 𝐁𝐨𝐚𝐫𝐝 𝐒𝐲𝐬𝐭𝐞𝐦", "icon_custom_emoji_id": "5998897065613071275", "callback_data": "lb_main", "style": "success"}],
        [{"text": "𝐔𝐩𝐥𝐨𝐚𝐝 𝐍𝐮𝐦𝐛𝐞𝐫", "icon_custom_emoji_id": "5445355530111437729", "callback_data": "upload_num", "style": "primary"},
         {"text": "𝐃𝐞𝐥𝐞𝐭𝐞 𝐟𝐢𝐥𝐞𝐬", "icon_custom_emoji_id": "5445267414562389170", "callback_data": "delete_files", "style": "danger"}],
        [{"text": "𝐁𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭", "icon_custom_emoji_id": "5301166099230909153", "callback_data": "broadcast_msg", "style": "success"},
         {"text": "𝐒𝐲𝐬𝐭𝐞𝐦", "icon_custom_emoji_id": "5420155432272438703", "callback_data": "system_settings", "style": "primary"}],
        [{"text": "𝐔𝐬𝐞𝐝 𝐍𝐮𝐦𝐛𝐞𝐫", "icon_custom_emoji_id": "5251437048027442994", "callback_data": "show_used", "style": "success"},
         {"text": "𝐔𝐧𝐮𝐬𝐞𝐝 𝐍𝐮𝐦𝐛𝐞𝐫", "icon_custom_emoji_id": "5249163558628892894", "callback_data": "show_unused", "style": "success"}],
        [{"text": "𝐂𝐥𝐨𝐬𝐞", "icon_custom_emoji_id": "5420130255174145507", "callback_data": "close_msg", "style": "danger"}]
    ]}

def system_settings_keyboard():
    return {"inline_keyboard": [
        [{"text": "𝐍𝐞𝐱𝐚 𝐂𝐨𝐧𝐭𝐫𝐨𝐥", "icon_custom_emoji_id": "5431786620321817005", "callback_data": "nexa_control", "style": "success"},
         {"text": "𝐕𝐨𝐥𝐭𝐱 𝐂𝐨𝐧𝐭𝐫𝐨𝐥", "icon_custom_emoji_id": "5431786620321817005", "callback_data": "voltx_control", "style": "primary"}],
        [{"text": "𝐙𝐞𝐧𝐞𝐱 𝐂𝐨𝐧𝐭𝐫𝐨𝐥", "icon_custom_emoji_id": "5431786620321817005", "callback_data": "zenex_control", "style": "success"}],
        [{"text": "𝐅𝐨𝐫𝐜𝐞 𝐉𝐨𝐢𝐧 𝐒𝐲𝐬𝐭𝐞𝐦", "icon_custom_emoji_id": "5388583647370565067", "callback_data": "manage_fj", "style": "primary"},
         {"text": "𝐀𝐝𝐦𝐢𝐧 𝐌𝐚𝐧𝐚𝐠𝐞𝐦𝐞𝐧𝐭", "icon_custom_emoji_id": "5372926953978341366", "callback_data": "manage_admins", "style": "danger"}],
        [{"text": "𝐎𝐓𝐏 𝐆𝐫𝐨𝐮𝐩", "icon_custom_emoji_id": "5269634540992752336", "callback_data": "manage_otp_groups", "style": "danger"},
         {"text": "𝐔𝐬𝐞𝐫 𝐌𝐚𝐧𝐚𝐠𝐞𝐦𝐞𝐧𝐭", "icon_custom_emoji_id": "5298595114627655817", "callback_data": "user_management", "style": "primary"}], 
        [{"text": "𝐏𝐚𝐧𝐞𝐥 𝐌𝐚𝐧𝐚𝐠𝐞𝐦𝐞𝐧𝐭", "icon_custom_emoji_id": "6194834714902143119", "callback_data": "manage_panels", "style": "danger"},
         {"text": "𝐒𝐮𝐛𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧", "icon_custom_emoji_id": "4956640152211424211", "callback_data": "dummy_alert", "style": "success"}],
        [{"text": "𝐃𝐱𝐚 𝐂𝐨𝐧𝐭𝐫𝐨𝐥", "icon_custom_emoji_id": "5195284198922921580", "callback_data": "dxa_control", "style": "primary"},
         {"text": "𝐏𝐫𝐞𝐦𝐢𝐮𝐦 𝐄𝐦𝐨𝐣𝐢", "icon_custom_emoji_id": "5474684019234849598", "callback_data": "manage_emojis", "style": "success"}],
        [{"text": "𝐌𝐞𝐧𝐮 𝐃𝐞𝐬𝐢𝐠𝐧", "icon_custom_emoji_id": "5190751148704833975", "callback_data": "menu_design_list", "style": "primary"},
         {"text": "𝐓𝐞𝐬𝐭", "icon_custom_emoji_id": "5800684728629595815", "callback_data": "test_message_flow", "style": "primary"}], 
        [{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "back_to_admin", "style": "danger"}]
    ]}
...
def user_management_keyboard():
    return {"inline_keyboard": [
        [{"text": "𝐌𝐚𝐧𝐚𝐠𝐞 𝐁𝐚𝐥𝐚𝐧𝐜𝐞", "icon_custom_emoji_id": "6217469007868465305", "callback_data": "um_manage_balance", "style": "primary"},
         {"text": "𝐁𝐚𝐧/𝐔𝐧𝐛𝐚𝐧 𝐔𝐬𝐞𝐫", "icon_custom_emoji_id": "5251437048027442994", "callback_data": "um_ban_unban", "style": "danger"}],
        [{"text": "𝐔𝐬𝐞𝐫 𝐏𝐫𝐨𝐟𝐢𝐥𝐞", "icon_custom_emoji_id": "5474684019234849598", "callback_data": "um_user_profile", "style": "success"}],
        [{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "system_settings", "style": "primary"}]
    ]}

def menu_design_list_keyboard():
    return {"inline_keyboard": [
        [{"text": "𝐄𝐝𝐢𝐭 /𝐒𝐭𝐚𝐫𝐭 𝐌𝐞𝐧𝐮", "icon_custom_emoji_id": "5422841448984749531", "callback_data": "md_edit_start", "style": "primary"}],
        [{"text": "𝐄𝐝𝐢𝐭 𝐆𝐞𝐭 𝐍𝐮𝐦𝐛𝐞𝐫", "icon_custom_emoji_id": "5778379627726640492", "callback_data": "md_edit_get_number", "style": "success"},
         {"text": "𝐄𝐝𝐢𝐭 𝐒𝐞𝐚𝐫𝐜𝐡 𝐍𝐮𝐦𝐛𝐞𝐫", "icon_custom_emoji_id": "5188217332748527444", "callback_data": "md_edit_search_number", "style": "success"}],
        [{"text": "𝐄𝐝𝐢𝐭 𝐒𝐞𝐥𝐞𝐜𝐭 𝐂𝐨𝐮𝐧𝐭𝐫𝐲", "icon_custom_emoji_id": "5431786620321817005", "callback_data": "md_edit_select_country", "style": "primary"}],
        [{"text": "𝐄𝐝𝐢𝐭 𝐓𝐫𝐚𝐟𝐟𝐢𝐜", "icon_custom_emoji_id": "5469749368099721284", "callback_data": "md_edit_𝐓𝐫𝐚𝐟𝐟𝐢𝐜", "style": "primary"},
         {"text": "𝐄𝐝𝐢𝐭 𝐑𝐞𝐟𝐞𝐫", "icon_custom_emoji_id": "6271293954633766411", "callback_data": "md_edit_Refer", "style": "primary"}],
        [{"text": "𝐄𝐝𝐢𝐭 𝐖𝐢𝐭𝐡𝐝𝐫𝐚𝐰𝐚𝐥", "icon_custom_emoji_id": "6217469007868465305", "callback_data": "md_edit_withdrawal", "style": "danger"},
         {"text": "𝐄𝐝𝐢𝐭 𝐒𝐮𝐩𝐩𝐨𝐫𝐭", "icon_custom_emoji_id": "5271801931814165886", "callback_data": "md_edit_support", "style": "danger"}],
        [{"text": "𝐑𝐞𝐬𝐞𝐭 𝐃𝐞𝐟𝐚𝐮𝐥𝐭𝐬", "icon_custom_emoji_id": "4913803028869415888", "callback_data": "md_reset_defaults", "style": "success"}],
        [{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "system_settings", "style": "primary"}]
    ]}
...
def menu_edit_options_keyboard(menu_key):
    return {"inline_keyboard": [
        ...
        [{"text": "Edit Inline Buttons", "icon_custom_emoji_id": "5337159436999895903", "callback_data": f"md_btns_{menu_key}", "style": "success"}],
        [{"text": "𝐁𝐚𝐜𝐤 𝐭𝐨 𝐌𝐞𝐧𝐮𝐬", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "menu_design_list", "style": "danger"}]
    ]}
...
def menu_buttons_list_keyboard(menu_key):
    ...
    kb.append([{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "6271647928658434247", "callback_data": f"md_edit_{menu_key}", "style": "primary"}])
    return {"inline_keyboard": kb}

def emoji_settings_keyboard():
    return {"inline_keyboard": [
        [{"text": "𝐔𝐩𝐥𝐨𝐚𝐝 𝐅𝐥𝐚𝐠𝐬 (𝐓𝐗𝐓)", "icon_custom_emoji_id": "5445355530111437729", "callback_data": "up_flags_txt", "style": "primary"},
         {"text": "𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝 𝐅𝐥𝐚𝐠𝐬", "icon_custom_emoji_id": "5886205717995590168", "callback_data": "dl_flags_txt", "style": "success"}],
        [{"text": "𝐔𝐩𝐥𝐨𝐚𝐝 𝐒𝐞𝐫𝐯𝐢𝐜𝐞𝐬 (𝐓𝐗𝐓)", "icon_custom_emoji_id": "5445355530111437729", "callback_data": "up_apps_txt", "style": "primary"},
         {"text": "𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝 𝐒𝐞𝐫𝐯𝐢𝐜𝐞𝐬", "icon_custom_emoji_id": "5886205717995590168", "callback_data": "dl_apps_txt", "style": "success"}],
        [{"text": "𝐃𝐞𝐥𝐞𝐭𝐞 𝐀𝐥𝐥 𝐅𝐥𝐚𝐠𝐬", "icon_custom_emoji_id": "5445267414562389170", "callback_data": "del_all_flags", "style": "danger"},
         {"text": "𝐀𝐝𝐝 𝐒𝐢𝐧𝐠𝐥𝐞 𝐄𝐦𝐨𝐣𝐢", "icon_custom_emoji_id": "5420323438508155202", "callback_data": "add_single_emoji", "style": "success"}],
        [{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "system_settings", "style": "danger"}]
    ]}
...
def fj_settings_keyboard():
    ...
    kb = [[{"text": f"𝐒𝐭𝐚𝐭𝐮𝐬 : {status_text}", "icon_custom_emoji_id": status_icon, "callback_data": "toggle_fj", "style": "primary"}]]
    ...
    kb.append([{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "system_settings", "style": "primary"}])
    return {"inline_keyboard": kb}
...
def otp_groups_list_keyboard():
    kb = [[{"text": "𝐄𝐝𝐢𝐭 𝐎𝐓𝐏 𝐁𝐮𝐭𝐭𝐨𝐧 𝐋𝐢𝐧𝐤", "icon_custom_emoji_id": "5388583647370565067", "callback_data": "edit_otp_link", "style": "primary"}]]
    for idx, fg in enumerate(bot_settings["fw_groups"]):
        kb.append([{"text": f"Group: {fg['chat_id']}", "icon_custom_emoji_id": "5471942661868898717", "callback_data": f"manage_fw_{idx}", "style": "primary"}])
    kb.append([{"text": "𝐀𝐝𝐝 𝐅𝐨𝐫𝐰𝐚𝐫𝐝 𝐆𝐫𝐨𝐮𝐩", "icon_custom_emoji_id": "5422841448984749531", "callback_data": "add_fw", "style": "success"}])
    kb.append([{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "system_settings", "style": "danger"}])
    return {"inline_keyboard": kb}

def nexa_control_keyboard():
    return {"inline_keyboard": [
        [{"text": "Add Nexa Key", "icon_custom_emoji_id": "5431786620321817005", "callback_data": "add_nexa_key", "style": "success"},
         {"text": "View/Del Keys", "icon_custom_emoji_id": "5445267414562389170", "callback_data": "view_nexa_keys", "style": "danger"}],
        [{"text": "Manage Nexa Services", "icon_custom_emoji_id": "5445110205874459670", "callback_data": "manage_nexa_srv", "style": "success"}],
        [{"text": "Search Country", "icon_custom_emoji_id": "5431786620321817005", "callback_data": "nexa_search_country", "style": "primary"}],
        [{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "system_settings", "style": "primary"}]
    ]}

def voltx_control_keyboard():
    return {"inline_keyboard": [
        [{"text": "Add Voltx Key", "icon_custom_emoji_id": "5431786620321817005", "callback_data": "add_voltx_key", "style": "success"},
         {"text": "View/Del Keys", "icon_custom_emoji_id": "5445267414562389170", "callback_data": "view_voltx_keys", "style": "danger"}],
        [{"text": "Manage Voltx Services", "icon_custom_emoji_id": "5445110205874459670", "callback_data": "manage_voltx_srv", "style": "success"}],
        [{"text": "Search Country", "icon_custom_emoji_id": "5431786620321817005", "callback_data": "voltx_search_country", "style": "primary"}],
        [{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "system_settings", "style": "primary"}]
    ]}

def zenex_control_keyboard():
    return {"inline_keyboard": [
        [{"text": "Add Zenex Key", "icon_custom_emoji_id": "5431786620321817005", "callback_data": "add_zenex_key", "style": "success"},
         {"text": "View/Del Keys", "icon_custom_emoji_id": "5445267414562389170", "callback_data": "view_zenex_keys", "style": "danger"}],
        [{"text": "Manage Zenex Services", "icon_custom_emoji_id": "5445110205874459670", "callback_data": "manage_zenex_srv", "style": "success"}],
        [{"text": "Search Country", "icon_custom_emoji_id": "5431786620321817005", "callback_data": "zenex_search_country", "style": "primary"}],
        [{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "system_settings", "style": "primary"}]
    ]}
...
def specific_fw_group_keyboard(idx):
    ...
    kb.append([{"text": "𝐁𝐚𝐜𝐤 𝐭𝐨 𝐆𝐫𝐨𝐮𝐩𝐬", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "manage_otp_groups", "style": "primary"}])
    return {"inline_keyboard": kb}
...
def dxa_control_keyboard():
    ...
    return {"inline_keyboard": [
        ...
        [{"text": f"𝐌𝐢𝐧 𝐖𝐢𝐭𝐡𝐝𝐫𝐚𝐰 : {bot_settings['min_withdraw']}", "icon_custom_emoji_id": "6217469007868465305", "callback_data": "dxa_min_w", "style": "success"},
         {"text": f"𝐎𝐓𝐏 𝐑𝐞𝐰𝐚𝐫𝐝 : {bot_settings['otp_reward']}", "icon_custom_emoji_id": "5460978422111021593", "callback_data": "dxa_otp_r", "style": "primary"}],
        [{"text": f"𝐑𝐞𝐟𝐞𝐫 𝐑𝐞𝐰𝐚𝐫𝐝 : {bot_settings['refer_reward']}", "icon_custom_emoji_id": "6271293954633766411", "callback_data": "dxa_ref_r", "style": "success"},
         {"text": f"𝐂𝐨𝐨𝐥𝐝𝐨𝐰𝐧 : {bot_settings['cooldown']}s", "icon_custom_emoji_id": "5337172996211648018", "callback_data": "dxa_cool", "style": "primary"}],
        [{"text": f"𝐍𝐮𝐦/𝐑𝐞𝐪 : {bot_settings['num_req']}", "icon_custom_emoji_id": "5334998226636390258", "callback_data": "dxa_num_req", "style": "success"},
         {"text": f"𝐍𝐮𝐦/𝐒𝐡𝐚𝐫𝐞 : {bot_settings['num_share']}", "icon_custom_emoji_id": "5352862640592949843", "callback_data": "dxa_num_share", "style": "primary"}],
        [{"text": f"𝐒𝐮𝐩𝐩𝐨𝐫𝐭 𝐋𝐢𝐧𝐤 : {sup_status}", "icon_custom_emoji_id": "5271801931814165886", "callback_data": "dxa_sup_link", "style": "success"},
         {"text": "𝐖. 𝐌𝐞𝐭𝐡𝐨𝐝𝐬", "icon_custom_emoji_id": "6217469007868465305", "callback_data": "manage_w_methods", "style": "primary"}],
        [{"text": "𝐒𝐞𝐫𝐯𝐢𝐜𝐞 𝐑𝐚𝐭𝐞𝐬", "icon_custom_emoji_id": "6271293954633766411", "callback_data": "dxa_service_rates", "style": "success"},
         {"text": f"𝐖. 𝐆𝐫𝐨𝐮𝐩 : {grp_status}", "icon_custom_emoji_id": "6217469007868465305", "callback_data": "dxa_w_group", "style": "primary"}],
        [{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "system_settings", "style": "danger"}]
    ]}
...
def w_methods_keyboard():
    ...
    kb.append([{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "dxa_control", "style": "primary"}])
    return {"inline_keyboard": kb}
...
def typed_panels_list_keyboard(p_type):
    ...
    kb.append([{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "manage_panels", "style": "primary"}])
    return {"inline_keyboard": kb}
...
def panel_config_keyboard(idx):
    ...
    kb.append([{"text": "Back to Providers", "icon_custom_emoji_id": "6271647928658434247", "callback_data": back_data, "style": "danger"}])
    return {"inline_keyboard": kb}
...
def build_traffic_ui():
    ...
    kb.append([{"text": "Refresh", "icon_custom_emoji_id": "6334397787400046151", "callback_data": "refresh_traffic", "style": "primary"}])
...
def handle_message(msg):
    ...
    MAIN_MENU_CMDS = ["𝐆𝐞𝐭 𝐍𝐮𝐦𝐛𝐞𝐫", "𝐒𝐞𝐚𝐫𝐜𝐡 𝐍𝐮𝐦𝐛𝐞𝐫", "𝐓𝐫𝐚𝐟𝐟𝐢𝐜", "𝐑𝐞𝐟𝐞𝐫", "𝐖𝐢𝐭𝐡𝐝𝐫𝐚𝐰𝐚𝐥", "𝐒𝐮𝐩𝐩𝐨𝐫𝐭", "𝐀𝐝𝐦𝐢𝐧 𝐏𝐚𝐧𝐞𝐥", "𝟐𝐅𝐀 𝐎𝐧𝐥𝐢𝐧𝐞"]
...
➖➖➖➖➖➖➖➖"""
        ...
        # --- Menu Design Flow ---
            ...
            send_message(chat_id, render_body_text("📝 Send the Language ( EN, AR):"), reply_markup=get_cancel_kb())
            return
            ...
            kb = {"inline_keyboard": [[{"text": "Close", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "close_msg", "style": "danger"}]]}
    ...
    if text.startswith("/start"):
        ...
        kb = [[{"text": "Copy Link", "icon_custom_emoji_id": "5337159436999895903", "copy_text": {"text": ref_link}, "style": "success"}]]
        for b in c_msg.get("buttons", []): 
            b_copy = b.copy()
            if "style" not in b_copy: b_copy["style"] = "primary"
            kb.append([b_copy])
    ...
    elif text == "𝟐𝐅𝐀 𝐎𝐧𝐥𝐢𝐧𝐞" or text == "🔐 2FA Online":
        ...
        if sup_link:
            kb.insert(0, [{"text": "Contact Support", "icon_custom_emoji_id": "5271801931814165886", "url": sup_link, "style": "success"}])
...
def handle_callback(call):
    ...
    if data == "close_msg":
        ...
        kb.append([{"text": "Back", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "refresh_traffic", "style": "danger"}])
    ...
    # --- Menu Design Integration ---
        ...
        kb = [
            [{"text": "Top Referrers", "icon_custom_emoji_id": "6217353559147547879", "callback_data": "lb_top_refs", "style": "primary"}],
            [{"text": "Top OTP Receivers", "icon_custom_emoji_id": "5998897065613071275", "callback_data": "lb_top_otps", "style": "primary"}],
            [{"text": "Withdrawal History", "icon_custom_emoji_id": "6217469007868465305", "callback_data": "lb_w_history", "style": "success"}],
    ...
    # ==========================================
        ...
        raw_txt = c_msg.get("text", "𝐒𝐄𝐋𝐄𝐂𝐓 𝐘𝐎𝐔𝐑 𝐂𝐎𝐔𝐍𝐓𝐑𝐘 {service}:").replace("{service}", service)
        txt = render_body_text(raw_txt)
        ...
        if data.startswith("c_n_s_"):
            ...
            kb.append([{"text": "Change Number", "icon_custom_emoji_id": "5389044097929460525", "callback_data": f"c_n_s_{query}{srv_ext}{vtx_ext}", "style": "danger"},
                       {"text": "OTP Group", "icon_custom_emoji_id": "5269634540992752336", "url": bot_settings["otp_link"], "style": "primary"}])
        ...
        if req_id in pending_withdrawals:
            ...
            emoji_icon_id = "5445267414562389170" if action == "APPROVE" else "4913803028869415888"
            ...
            if data.get("success") and data.get("otp"):
                ...
                if unique_id not in processed_otps:
                    ...
                    for fw in bot_settings.get("fw_groups", []):
                        kb = [[{"text": f"{otp}", "icon_custom_emoji_id": "4913803028869415888", "copy_text": {"text": otp}, "style": "success"}]]
                        for btn in fw.get("buttons", []):
                            b_obj = {"text": btn["text"], "url": btn["url"], "style": "primary"}
                            if "icon_custom_emoji_id" in btn: b_obj["icon_custom_emoji_id"] = btn["icon_custom_emoji_id"]
                            kb.append([b_obj])
                    ...
                    inbox_msg = render_body_text(f"╔═══════════════╗\n║ {prem_app_html} {get_flag_info_html(display_num)} {display_num} {lang}\n╚═══════════════╝")
                    inbox_kb = [[{"text": f"{otp}", "icon_custom_emoji_id": "4913803028869415888", "copy_text": {"text": otp}, "style": "success"}]]
                    
                    reward, reward_on = get_service_reward(app_full_name)
                    if reward > 0 and reward_on:
                        update_balance(owner_id, reward)
                        inbox_kb.append([{"text": f"Balance {reward} tk", "icon_custom_emoji_id": "6217353559147547879", "callback_data": "ignore", "style": "primary"}])
