...
def main_menu(user_id):
    kb = [
        [
            {"text": "Get Number", "icon_custom_emoji_id": "5778379627726640492", "style": "primary"}, 
            {"text": "Search Number", "icon_custom_emoji_id": "5188217332748527444", "style": "primary"}
        ],
        [
            {"text": "Traffic", "icon_custom_emoji_id": "5469749368099721284", "style": "success"}, 
            {"text": "2FA Online", "icon_custom_emoji_id": "5206432422194849059", "style": "primary"}
        ],
        [
            {"text": "Refer", "icon_custom_emoji_id": "6271293954633766411", "style": "success"}, 
            {"text": "Withdrawal", "icon_custom_emoji_id": "6217469007868465305", "style": "danger"}
        ],
        [
            {"text": "Support", "icon_custom_emoji_id": "5271801931814165886", "style": "primary"}
        ]
    ]
    if is_admin(user_id): 
...
def menu_design_list_keyboard():
    return {"inline_keyboard": [
        ...
        [{"text": "Edit Get Number", "icon_custom_emoji_id": "5778379627726640492", "callback_data": "md_edit_get_number", "style": "success"},
         {"text": "Edit Search Number", "icon_custom_emoji_id": "5188217332748527444", "callback_data": "md_edit_search_number", "style": "success"}],
        [{"text": "Edit Select Country", "icon_custom_emoji_id": "5431786620321817005", "callback_data": "md_edit_select_country", "style": "primary"}],
        [{"text": "Edit Traffic", "icon_custom_emoji_id": "5469749368099721284", "callback_data": "md_edit_traffic", "style": "primary"},
         {"text": "Edit Refer", "icon_custom_emoji_id": "6271293954633766411", "callback_data": "md_edit_refer", "style": "primary"}],
        [{"text": "Edit Withdrawal", "icon_custom_emoji_id": "6217469007868465305", "callback_data": "md_edit_withdrawal", "style": "danger"},
         {"text": "Edit Support", "icon_custom_emoji_id": "5271801931814165886", "callback_data": "md_edit_support", "style": "danger"}],
