...
def admin_panel_keyboard():
    return {"inline_keyboard": [
        [{"text": "LEADER BOARD SYSTEM", "icon_custom_emoji_id": "5998897065613071275", "callback_data": "lb_main", "style": "success"}],
        [{"text": "Upload Number", "icon_custom_emoji_id": "5445355530111437729", "callback_data": "upload_num", "style": "primary"},
         {"text": "Delete files", "icon_custom_emoji_id": "5445267414562389170", "callback_data": "delete_files", "style": "danger"}],
        [{"text": "Broadcast", "icon_custom_emoji_id": "5301166099230909153", "callback_data": "broadcast_msg", "style": "success"},
         {"text": "System", "icon_custom_emoji_id": "5420155432272438703", "callback_data": "system_settings", "style": "primary"}],
        [{"text": "Used number", "icon_custom_emoji_id": "5251437048027442994", "callback_data": "show_used", "style": "success"},
         {"text": "Unused number", "icon_custom_emoji_id": "4913803028869415888", "callback_data": "show_unused", "style": "success"}],
        [{"text": "Close", "icon_custom_emoji_id": "5420130255174145507", "callback_data": "close_msg", "style": "danger"}]
    ]}

def system_settings_keyboard():
    return {"inline_keyboard": [
        [{"text": "Nexa Control", "icon_custom_emoji_id": "5431786620321817005", "callback_data": "nexa_control", "style": "success"},
         {"text": "Voltx Control", "icon_custom_emoji_id": "5431786620321817005", "callback_data": "voltx_control", "style": "primary"}],
        [{"text": "Zenex Control", "icon_custom_emoji_id": "5431786620321817005", "callback_data": "zenex_control", "style": "success"}],
        [{"text": "Force Join System", "icon_custom_emoji_id": "5388583647370565067", "callback_data": "manage_fj", "style": "primary"},
         {"text": "Admin Management", "icon_custom_emoji_id": "5372926953978341366", "callback_data": "manage_admins", "style": "danger"}],
        [{"text": "OTP Group", "icon_custom_emoji_id": "5269634540992752336", "callback_data": "manage_otp_groups", "style": "danger"},
         {"text": "User Management", "icon_custom_emoji_id": "5298595114627655817", "callback_data": "user_management", "style": "primary"}], 
        [{"text": "Panel MANAGEMENT", "icon_custom_emoji_id": "6194834714902143119", "callback_data": "manage_panels", "style": "danger"},
         {"text": "Subscription", "icon_custom_emoji_id": "4956640152211424211", "callback_data": "dummy_alert", "style": "success"}],
        [{"text": "DXA Control", "icon_custom_emoji_id": "5195284198922921580", "callback_data": "dxa_control", "style": "primary"},
         {"text": "Premium Emoji", "icon_custom_emoji_id": "5474684019234849598", "callback_data": "manage_emojis", "style": "success"}],
        [{"text": "Menu Design", "icon_custom_emoji_id": "5190751148704833975", "callback_data": "menu_design_list", "style": "primary"},
         {"text": "Test", "icon_custom_emoji_id": "5800684728629595815", "callback_data": "test_message_flow", "style": "primary"}], 
        [{"text": "Back", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "back_to_admin", "style": "danger"}]
    ]}
...
def user_management_keyboard():
    return {"inline_keyboard": [
        [{"text": "Manage Balance", "icon_custom_emoji_id": "6217469007868465305", "callback_data": "um_manage_balance", "style": "primary"},
         {"text": "Ban/Unban User", "icon_custom_emoji_id": "5251437048027442994", "callback_data": "um_ban_unban", "style": "danger"}],
        [{"text": "User Profile", "icon_custom_emoji_id": "5474684019234849598", "callback_data": "um_user_profile", "style": "success"}],
        [{"text": "Back", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "system_settings", "style": "primary"}]
    ]}

def menu_design_list_keyboard():
    return {"inline_keyboard": [
        [{"text": "Edit /start Menu", "icon_custom_emoji_id": "5422841448984749531", "callback_data": "md_edit_start", "style": "primary"}],
        [{"text": "Edit 𝐆𝐞𝐭 𝐍𝐮𝐦𝐛𝐞𝐫", "icon_custom_emoji_id": "5778379627726640492", "callback_data": "md_edit_get_number", "style": "success"},
         {"text": "Edit 𝐒𝐞𝐚𝐫𝐜𝐡 𝐍𝐮𝐦𝐛𝐞𝐫", "icon_custom_emoji_id": "5188217332748527444", "callback_data": "md_edit_search_number", "style": "success"}],
        [{"text": "Edit Select Country", "icon_custom_emoji_id": "5431786620321817005", "callback_data": "md_edit_select_country", "style": "primary"}],
        [{"text": "Edit Traffic", "icon_custom_emoji_id": "5469749368099721284", "callback_data": "md_edit_𝐓𝐫𝐚𝐟𝐟𝐢𝐜", "style": "primary"},
         {"text": "Edit 𝐑𝐞𝐟𝐞𝐫", "icon_custom_emoji_id": "6271293954633766411", "callback_data": "md_edit_Refer", "style": "primary"}],
        [{"text": "Edit 𝐖𝐢𝐭𝐡𝐝𝐫𝐚𝐰𝐚𝐥", "icon_custom_emoji_id": "6217469007868465305", "callback_data": "md_edit_withdrawal", "style": "danger"},
         {"text": "Edit 𝐒𝐮𝐩𝐩𝐨𝐫𝐭", "icon_custom_emoji_id": "5271801931814165886", "callback_data": "md_edit_support", "style": "danger"}],
        [{"text": "Reset Defaults", "icon_custom_emoji_id": "4913803028869415888", "callback_data": "md_reset_defaults", "style": "success"}],
        [{"text": "Back", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "system_settings", "style": "primary"}]
    ]}
...
def menu_edit_options_keyboard(menu_key):
    return {"inline_keyboard": [
        ...
        [{"text": "Back to Menus", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "menu_design_list", "style": "danger"}]
    ]}
...
def menu_buttons_list_keyboard(menu_key):
    ...
    kb.append([{"text": "Back", "icon_custom_emoji_id": "6271647928658434247", "callback_data": f"md_edit_{menu_key}", "style": "primary"}])
    return {"inline_keyboard": kb}

def emoji_settings_keyboard():
    return {"inline_keyboard": [
        [{"text": "Upload Flags (TXT)", "icon_custom_emoji_id": "5445355530111437729", "callback_data": "up_flags_txt", "style": "primary"},
         {"text": "Download Flags", "icon_custom_emoji_id": "5886205717995590168", "callback_data": "dl_flags_txt", "style": "success"}],
        [{"text": "Upload Services (TXT)", "icon_custom_emoji_id": "5445355530111437729", "callback_data": "up_apps_txt", "style": "primary"},
         {"text": "Download Services", "icon_custom_emoji_id": "5886205717995590168", "callback_data": "dl_apps_txt", "style": "success"}],
        [{"text": "Delete All Flags", "icon_custom_emoji_id": "5445267414562389170", "callback_data": "del_all_flags", "style": "danger"},
         {"text": "Add Single Emoji", "icon_custom_emoji_id": "5420323438508155202", "callback_data": "add_single_emoji", "style": "success"}],
        [{"text": "Back", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "system_settings", "style": "danger"}]
    ]}
...
def fj_settings_keyboard():
    ...
    kb.append([{"text": "Back", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "system_settings", "style": "primary"}])
    return {"inline_keyboard": kb}
...
def otp_groups_list_keyboard():
    kb = [[{"text": "Edit OTP Button Link", "icon_custom_emoji_id": "5388583647370565067", "callback_data": "edit_otp_link", "style": "primary"}]]
    ...
    kb.append([{"text": "Add Forward Group", "icon_custom_emoji_id": "5422841448984749531", "callback_data": "add_fw", "style": "success"}])
    kb.append([{"text": "Back", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "system_settings", "style": "danger"}])
    return {"inline_keyboard": kb}
...
def specific_fw_group_keyboard(idx):
    ...
    kb.append([{"text": "Back to Groups", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "manage_otp_groups", "style": "primary"}])
    return {"inline_keyboard": kb}
...
def dxa_control_keyboard():
    ...
    return {"inline_keyboard": [
        ...
        [{"text": f"MIN WITHDRAW: {bot_settings['min_withdraw']}", "icon_custom_emoji_id": "6217469007868465305", "callback_data": "dxa_min_w", "style": "success"},
         {"text": f"OTP REWARD: {bot_settings['otp_reward']}", "icon_custom_emoji_id": "5460978422111021593", "callback_data": "dxa_otp_r", "style": "primary"}],
        [{"text": f"REFER REWARD: {bot_settings['refer_reward']}", "icon_custom_emoji_id": "6271293954633766411", "callback_data": "dxa_ref_r", "style": "success"},
         {"text": f"COOLDOWN: {bot_settings['cooldown']}s", "icon_custom_emoji_id": "5337172996211648018", "callback_data": "dxa_cool", "style": "primary"}],
        [{"text": f"NUM/REQ: {bot_settings['num_req']}", "icon_custom_emoji_id": "5334998226636390258", "callback_data": "dxa_num_req", "style": "success"},
        ...
        [{"text": f"Support Link: {sup_status}", "icon_custom_emoji_id": "5271801931814165886", "callback_data": "dxa_sup_link", "style": "success"},
         {"text": "W. METHODS", "icon_custom_emoji_id": "6217469007868465305", "callback_data": "manage_w_methods", "style": "primary"}],
        [{"text": "SERVICE RATES", "icon_custom_emoji_id": "6271293954633766411", "callback_data": "dxa_service_rates", "style": "success"},
         {"text": f"W. GROUP: {grp_status}", "icon_custom_emoji_id": "6217469007868465305", "callback_data": "dxa_w_group", "style": "primary"}],
        [{"text": "BACK", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "system_settings", "style": "danger"}]
    ]}
...
def w_methods_keyboard():
    ...
    kb.append([{"text": "Back", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "dxa_control", "style": "primary"}])
    return {"inline_keyboard": kb}
...
def typed_panels_list_keyboard(p_type):
    ...
    kb.append([{"text": "Back", "icon_custom_emoji_id": "6271647928658434247", "callback_data": "manage_panels", "style": "primary"}])
    return {"inline_keyboard": kb}
